...
/* La gestion du compte personnel est regroupée dans « Mon profil » :
   on redirige les anciens liens plutôt que de les laisser sans destination. */
if (($_GET['section'] ?? '') === 'motdepasse') { header('Location: profil.php'); exit; }
