...
/* Version interne du générateur : appelée depuis la messagerie pour produire
   la pièce jointe. L'utilisateur est déjà authentifié, et le PDF est renvoyé
   sans en-tête HTTP puisqu'il part dans un email. */
if (!isset($pdo)) { require __DIR__ . '/includes/auth.php'; }
