...
$renderDoc = function($f) use ($doc, $devise) {
    ...
    <div class="rng-doc">
      ...
      <span class="acts">
        ...
        <?php endif; ?>
        <a class="btn btn-glass btn-sm" href="pdf.php?type=<?= $doc ?>&id=<?= $f['id'] ?>" target="_blank" title="Voir / Imprimer">📄</a>
        <?php if($doc==='facture'): ?><a class="btn btn-glass btn-sm" href="pdf.php?type=livraison&id=<?= $f['id'] ?><?= is_admin() ? '&auth=1' : '' ?>" target="_blank" title="Bon de livraison">🚚</a>
        <a class="btn btn-gold btn-sm" href="pdf.php?type=livraison&id=<?= $f['id'] ?>&dl=1" title="Bon de livraison en PDF">⬇️🚚</a><?php endif; ?>
